...
class ExpertSystemGUI:
    def __init__(self, root, Fields, engine):
        self.root = root
        self.root.title("Heart Disease Diagnosis")
        self.engine = engine
        self.Fields = Fields
    ...
    def create_widgets(self):
        self.input_frame = ScrolledFrame(self.root, autohide=True)
        ...
        self.info_frame = tb.Frame(self.root, padding=20)
        ...
        self.facts_listbox = tb.ScrolledText(self.info_frame, height=12, width=40, font=("Consolas", 10))
        self.facts_listbox.pack(pady=10)

        self.rules_label = tb.Label(self.info_frame, text="Fired Rules:", font=("Segoe UI", 12, "bold"))
        self.rules_label.pack(anchor=W)

        self.rules_listbox = tb.ScrolledText(self.info_frame, height=10, width=40, font=("Consolas", 10))
